...
<section>
  ...
  <div>
    <div class="uk-card-body">
      ...
      <p style="font-family: DynaPuff; color: rgb(43, 44, 65); text-align: justify; font-size: 1rem;">
...
<section>
  ...
  <section>
    ...
    <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid style="padding: 20px; margin: auto; width: 80%; margin-bottom:2%; margin-top:2%;">
      ...
      <div>
        <div class="uk-card-body" style="padding: 20px;">
          <h3 class="uk-card-title" style="font-family: DynaPuff; color:rgb(43, 44, 65); font-size: 34px;">Company</h3>
            <p style="font-family: DynaPuff; color:rgb(43, 44, 65); text-align: justify; font-size: 24px;">
